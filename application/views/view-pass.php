									...
									<div class="box-body">
										<?php
											...
											<table class="table text-dark table-bordered table-striped">
		                                        ...
		                                        <tr>
		                                        	<form class="" method="POST" action="<?php echo CORE;?>crm-functions.php?case=viewpass&p=<?php echo $pageName;?>">
		                                        	<td><input type="hidden" name="gateid" value="<?php echo $_GET['ids'];?>"></td>
		                                            <td>
		                                            	<input type="submit" name="viewpass" class="btn btn-primary float-right" value="Ok & Save">
