			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="login-set">
						...
						<form class="" method="POST" action="<?php echo CORE;?>login-functions.php?case=login">
							<div class="form-group">
								...
								<div class="input-group">
								    ...
								    <input type="text" class="form-control inputcolor" name="fname" placeholder="User Email or Employee ID" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input type="submit" class="btn btn-danger mt-3 px-5" value="Login" name="userlogin">
