			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="login-set">
						...
						<form class="" method="POST" action="<?php echo CORE;?>login-functions.php?case=access&eid=<?php echo $_GET['eid']?>">
							...
							<div class="form-group">
								...
								<input type="submit" class="btn btn-danger mt-3 px-5" value="Login" name="loginAccess">
